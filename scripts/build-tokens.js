/**
 * Script para definir tokens do design system para uso com Tailwind CSS
 */
...
// Função para criar tokens estáticos
async function buildTokens() {
  try {
    console.log('🔄 Iniciando compilação de tokens do design system...');

    // Criar um conjunto fixo de tokens para uso com Tailwind
    const tokensContent = `/**
...
`;
    ...
    // Escrever o arquivo de tokens
    fs.writeFileSync(outputFile, tokensContent);
