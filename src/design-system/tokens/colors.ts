...
export const semanticColors = {
  ...
  error: {
    ...
    main: colorPalette.red[600],
    dark: colorPalette.red[800],
    contrast: '#ffffff',
  },
  
  warning: {
    light: colorPalette.yellow[400],
    main: colorPalette.yellow[700],
    dark: colorPalette.yellow[800],
    contrast: '#000000',
  },
  
  info: {
    light: colorPalette.blue[400],
    main: colorPalette.blue[600],
